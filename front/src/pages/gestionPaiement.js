...
import { fetchPaiement, deletePaiement, validatePaiement, createPaiement, updatePaiement } from "../services";
                                ...
                                {editingId === paiement.id ? (
                                    <>
                                        ...
                                        <td>
                                            ...
                                            {paiement.statut !== 'Validé' ? <button onClick={() => handleValidate(paiement.id)}>Valider</button> : null}
                                        </td>
                                    </>
                                ) : (
                                    <>
