                ...
                <div className='filters'>
                    <div className='filter-section'>
                        <label>
                            ...
                            <select name="typeDePropriete" id="typeDePropriete" value={filtres.typeDePropriete} onChange={handleInputChange}>
                        ...
                        <label>
                            <h5>Chambres</h5>
                            <select name="nombreChambres" id="nombreChambres" value={filtres.nombreChambres} onChange={handleInputChange}>
                                <option value="">Tout</option>
                        ...
                        <label>
                            <h5>Lits</h5>
                            <select name="nombreLits" id="nombreLits" value={filtres.nombreLits} onChange={handleInputChange}>
                                <option value="">Tout</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                        ...
                        <label>
                            ...
                            <select name="nombreSallesDeBain" id="nombreSallesDeBain" value={filtres.nombreSallesDeBain} onChange={handleInputChange}>
                                <option value="">Tout</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                        ...
                        <label>
                            <h5>Prix</h5>
                            <input type='number' name='prixMin' value={filtres.prixMin} onChange={handleInputChange} placeholder='Prix min' />
                            <input type='number' name='prixMax' value={filtres.prixMax} onChange={handleInputChange} placeholder='Prix max' />
                        </label>
                    </div>
                    <br></br>
                    <h4>Équipements</h4>
                    <div className='filter-checkboxes'>
                        ...
                        <label>
                            <input type="checkbox" name="cuisine" className="form-check-input" value={filtres.cuisine} onChange={handleInputChange} />
                            Cuisine
                        </label>
                        <label>
                            <input type="checkbox" name="balcon" className="form-check-input" value={filtres.balcon} onChange={handleInputChange} />
                            Balcon
                        </label>
                        <label>
                            <input type="checkbox" name="jardin" className="form-check-input" value={filtres.jardin} onChange={handleInputChange} />
                            Jardin
                        </label>
                        <label>
                            <input type="checkbox" name="parking" className="form-check-input" value={filtres.parking} onChange={handleInputChange} />
                            Parking
                        </label>
                        <label>
                            <input type="checkbox" name="piscine" className="form-check-input" value={filtres.piscine} onChange={handleInputChange} />
                            Piscine
                        </label>
                        <label>
                            <input type="checkbox" name="jaccuzzi" className="form-check-input" value={filtres.jaccuzzi} onChange={handleInputChange} />
                            Jaccuzzi
                        </label>
                        <label>
                            <input type="checkbox" name="salleDeSport" className="form-check-input" value={filtres.salleDeSport} onChange={handleInputChange} />
                            Salle de sport
                        </label>
                        <label>
                            <input type="checkbox" name="climatisation" className="form-check-input" value={filtres.climatisation} onChange={handleInputChange} />
                            Climatisation
                        </label>
                    </div>
                </div>
