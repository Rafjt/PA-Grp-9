...
const GestionAnnonce = () => {
  ...
  const currentItems = annonces
    .filter(
      (annonce) =>
        annonce &&
        (annonce.nomBien.toLowerCase().includes(searchTerm.toLowerCase()) ||
          annonce.id.toString() === searchTerm ||
          annonce.propertyName
            .toLowerCase()
          ...
          <div className="filter-section">
            <label>
              ...
              <select
                name="typeDePropriete"
                id="typeDePropriete"
                value={filterValues.typeDePropriete}
            ...
            <label>
              ...
              <select
                name="nombreChambres"
                id="nombreChambres"
                value={filterValues.nombreChambres}
                onChange={handleFilterChange}
              >
                <option value="Tout">Tout</option>
            ...
            <label>
              ...
              <select
                ...
                value={filterValues.nombreSallesDeBain}
                onChange={handleFilterChange}
              >
                <option value="Tout">Tout</option>
                <option value="1">1</option>
          ...
          <div className="filter-checkboxes">
            ...
            <label>
              <input
                ...
                name="salleDeSport"
                className="form-check-input"
                value={filterValues.salleDeSport}
                onChange={handleFilterChange}
              />
              Salle de sport
            </label>
            <label>
              <input
                ...
                name="climatisation"
                className="form-check-input"
                value={filterValues.climatisation}
                onChange={handleFilterChange}
              />
              Climatisation
            </label>
  ...
  {currentItems.map((annonce) => (
    <div key={annonce.id} className="annonce rounded shadow">
      <img
        src={`${BACK_URL}/uploads/${annonce.cheminImg}`}
        alt={annonce.nomBien}
        className="gestionAnnonceImg"
      />
      <h2>
        ID: {annonce.id}, {annonce.nomBien}
      </h2>
      <h2>
        ID du client bailleur propriétaire: {annonce.id_ClientBailleur}
      </h2>
  ...
  <div className="paginationContainer">
    ...
    {annonces.length > itemsPerPage &&
      Array.from(
        { length: Math.ceil(annonces.length / itemsPerPage) },
        (_, index) => (
    ...
    <button
      onClick={() => paginate(currentPage + 1)}
      disabled={indexOfLastItem >= annonces.length}
    >
      Suivant
    </button>
  </div>
