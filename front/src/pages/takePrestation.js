      ...
      {prestations &&
        prestations.map((prestation, index) => (
          <div key={index} className="prestation-card">
            ...
            <p>
              Type: <span>{prestation.typeIntervention}</span>
            </p>
            <p>
              Date: <span>{prestation.date}</span>
            </p>
            <p>
              Lieux: <span>{prestation.lieux}</span>
            </p>
            <p>
              Ville: <span>{prestation.ville}</span>
            </p>
            <p className="description">
              Description: <span>{prestation.description}</span>
            </p>
            <p>
              Statut: <span>{prestation.statut}</span>
            </p>
            <hr />
            <button
              className="place-button"
              onClick={() => acceptPresta(prestation.id)}
            >
              Me placer
            </button>
          </div>
